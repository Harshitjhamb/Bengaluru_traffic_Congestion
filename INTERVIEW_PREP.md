...
- Also present: `priority_feature_cols` (47 cols), `closure_feature_cols` (69 cols), `duration_feature_cols`, `closure_threshold` (0.625), `cat_features`/`num_features` (+ `_fixed` variants), `cause_score_map`, `manpower_map`, `zone_station_map` (10 zones), `station_coords` (8,120 rows), `corridor_coords` (8,101 rows).
